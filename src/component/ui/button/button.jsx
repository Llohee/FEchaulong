...
const buttonStyles = cva(
  "relative flex justify-center items-center gap-1.5 whitespace-nowrap overflow-hidden tracking-wide transition-all disabled:cursor-not-allowed",
  {
    variants: {
      intent: {
        brand:
      ...
      posting: {
        true: "duration-0 !text-transparent !fill-transparent !stroke-transparent",
      },
      ...
      >
        ...
        >
          <svg
            ...
            className="w-6 h-6 animate-spin fill-white stroke-0"
          >
