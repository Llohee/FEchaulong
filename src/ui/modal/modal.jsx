      ...
      >
        ...
        >
          ...
          <div className="fixed inset-1 flex flex-col gap-3 items-center justify-center p-4 text-center">
            <button
              type="button"
              className="flex justify-center bg-slate-100 rounded-full p-3 hover:bg-grey-3 items-center gap-1.5 whitespace-nowrap overflow-hidden tracking-wide transition-all duration-200 transform focus:outline-none active:focus:duration-0 disabled:cursor-not-allowed"
            ...
            >
              <motion.div
                className={
                  ...
                  } transform overflow-hidden rounded-2xl bg-slate-300 p-0 text-left align-middle shadow-xl ${
                    props.className ?? ""
                  }`
                }
              ...
              >
                <Dialog.Panel>
                  {props.title && (
                    <Dialog.Title
                      as="h3"
                      className={`w-full flex flex-shrink-0 items-center justify-between py-4 px-6 border-b-slate-300 border  bg-slate-100/50 z-50 text-heading-7 text-typography-title rounded-t-2xl ${
